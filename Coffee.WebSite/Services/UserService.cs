...
public class UserService : IUserService
{
    ...
    public async Task<Response<List<UserDto>>> GetAllAsync()
    {
        ...
        return JsonConvert.DeserializeObject<Response<List<UserDto>>>(json)!;
    }
    ...
    public async Task<Response<UserDto>> GetByIdAsync(int id)
    {
        ...
        var json = await res.Content.ReadAsStringAsync();
        return JsonConvert.DeserializeObject<Response<UserDto>>(json)!;
    }
    ...
    public async Task<Response<UserDto>> CreateAsync(UserDto dto)
    {
        ...
        return JsonConvert.DeserializeObject<Response<UserDto>>(jsonResponse)!;
    }

    public async Task<Response<UserDto>> UpdateAsync(UserDto dto)
    {
        var json = JsonConvert.SerializeObject(dto);
        var content = new StringContent(json, Encoding.UTF8, "application/json");
